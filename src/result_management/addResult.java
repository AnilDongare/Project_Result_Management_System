...
public class addResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/srms","root","218222");
            
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("select * from student where rollno = '"+roll+"'");
            
            if(rs.next()){
                st.executeUpdate("insert into result(rollno,physics,math,em,dbms,os) values('"+roll+"','"+physics+"','"+maths+"','"+em+"','"+dbms+"','"+os+"')");
                JOptionPane.showMessageDialog(null, "Marks Saved Sucessfully!");
                setVisible(false);
                new addResult().setVisible(true);
            }
            else{
                JOptionPane.showMessageDialog(null, "This roll no is registered!");
            }
